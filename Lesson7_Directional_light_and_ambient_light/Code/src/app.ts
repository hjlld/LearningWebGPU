...
import { TypedArray, MaxEquation } from 'three';
...
export class App {
    ...
    public InitGPUBufferWithMultiBuffers( vxArray: Float32Array, uvArray: Float32Array, normalArray: Float32Array, positionUniformArray: TypedArray, lightUniformArray: TypedArray, idxArray: Uint32Array, texture: GPUTexture, sampler: GPUSampler ) {
        ...
        let normalBuffer = this._CreateGPUBuffer( normalArray, GPUBufferUsage.VERTEX );

        this.renderPassEncoder.setVertexBuffer( 2, normalBuffer, 0 );
        ...
        let lightUniformBuffer = this._CreateGPUBuffer( lightUniformArray, GPUBufferUsage.UNIFORM );
        ...
        let uniformBindGroup = this.device.createBindGroup( {
            ...
            entries: [ 
                
                {
                    ...
                    resource: { buffer: positionUniformBuffer }
